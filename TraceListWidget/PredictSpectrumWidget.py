...
class PredictSpectrum(QWidget):
    ...
    def generate_spectrum(self):
        ...
        sideband_orders = [[i, j, k] for i in range(-order1, order1 + 1) for j in range(-order2, order2 + 1) for k in
                           range(-order3, order3 + 1)]
