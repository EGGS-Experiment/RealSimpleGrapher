...
class Lorentzian(Model):
    ...
    def model(self, x, p):
        '''
        Base Lorentzian model.
        Using definition from http://mathworld.wolfram.com/LorentzianFunction.html,
        where we add an overall scale factor to change the peak height.
